...
const LogomarkIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g filter="url(#a)">
      <g clip-path="url(#b)">
        ...
        <path
          fill="#D0D5DD"
          d="M29.602 2h.078v32h-.078V2ZM13.64 2h.078v32h-.077V2Zm10.642 0h.077v32h-.078V2ZM8.32 2h.078v32H8.32V2Z"
        />
        <path
          fill="#D0D5DD"
      ...
      <path
        stroke="#D0D5DD"
        stroke-width=".2"
        d="M3.1 14.8c0-2.242 0-3.917.109-5.246.108-1.328.324-2.301.752-3.14A7.9 7.9 0 0 1 7.413 2.96c.84-.428 1.813-.644 3.14-.752C11.884 2.1 13.559 2.1 15.8 2.1h6.4c2.242 0 3.917 0 5.246.109 1.328.108 2.301.324 3.14.752a7.9 7.9 0 0 1 3.453 3.452c.428.84.644 1.813.752 3.14.109 1.33.109 3.005.109 5.247v6.4c0 2.242 0 3.917-.109 5.246-.108 1.328-.324 2.301-.752 3.14a7.9 7.9 0 0 1-3.453 3.453c-.839.428-1.812.644-3.14.752-1.329.109-3.004.109-5.246.109h-6.4c-2.242 0-3.917 0-5.246-.109-1.328-.108-2.301-.324-3.14-.752a7.9 7.9 0 0 1-3.453-3.453c-.428-.839-.644-1.812-.752-3.14C3.1 25.117 3.1 23.442 3.1 21.2v-6.4Z"
      />
    </g>
    <defs>
      <filter
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_2601_217"
        />
        <feColorMatrix
          in="SourceAlpha"
          result="hardAlpha"
        ...
        <feBlend
          in2="effect1_dropShadow_2601_217"
          result="effect2_dropShadow_2601_217"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect2_dropShadow_2601_217"
          result="shape"
        />
      </filter>
      <filter
      ...
      >
        ...
        <feComposite
          in2="SourceAlpha"
          operator="in"
          result="effect1_backgroundBlur_2601_217"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect1_backgroundBlur_2601_217"
          result="shape"
        />
      </filter>
      <linearGradient
